...
//konusma balonu
 for(a=0;a<1300;a+=10)
 {
  ...
  rectangle(10+a,100,800+a,700);//konusma balonu
    ...
    outtextxy(200+a,200,"KORONA NEDENÝYLE");  //konusma balonu	
	settextstyle(2,HORIZ_DIR,17);  //konusma balonu
    outtextxy(90+a,300," METROYA SINIRLI YOLCU  ALIMI");//konusma balonu
    setcolor(BLUE);
setcolor(BROWN);
    settextstyle(2,HORIZ_DIR,17);  //konusma balonu
    outtextxy(450+a,625," OZAN KÖRTELLÝ");//konusma balonu
	  delay(100);
cleardevice();
 }
...
{  //gorevli
	setcolor(BLUE)  ;
         arc(650,40,0,180,12);//þapka
	  line(640,40,670,40);// þapka
	  settextstyle(2,HORIZ_DIR,5); // þapka
      outtextxy(645,30,"G"); // þapka
	setcolor(BLUE);
...
{setcolor(BLUE);
	 ...
	 rectangle(125,200,750,300);
      settextstyle(4,HORIZ_DIR,4);  //DURAK
 outtextxy(320,230,"GÖZTEPE");   //DURAK
}
...
delay(500);
    ...
    circle(700,135,10);
           ...
           rectangle(540,50,580,80);//sayaç
   settextstyle(3,HORIZ_DIR,4); //sayaç
      outtextxy(550,50,"-");//sayaç
   rectangle(580,50,620,80);//sayaç
	  settextstyle(3,HORIZ_DIR,4); //sayaç
      outtextxy(580,50,"-");//sayaç
	    }
...
adam3(i);
  ...
  setcolor(WHITE);
   ...
   ilkgelenmetro(x,j);
    setcolor(WHITE);
	  ...
	  rectangle(540,50,580,80);//sayaç
   settextstyle(3,HORIZ_DIR,4); //sayaç
      outtextxy(550,50,"0");//sayaç
   rectangle(580,50,620,80);//sayaç
	  settextstyle(3,HORIZ_DIR,4); //sayaç
      outtextxy(580,50,"4");//sayaç
	 konusmabalonu();
 ...
 // metronun kendisi icin renk degisimi
     ...
     line(450+o,400,500+o,430);
      ...
      circle(170+o,440,10);//metro içindeki yolcu 1 kafa
      line(170+o,450,170+o,480);//metro içindeki yolcu 1 gövde
      line(170+o,480,190+o,500);//metro içindeki yolcu 1 ayak
       line(170+o,460,180+o,470);//metro içindeki yolcu 1 kol
	  line(160+o,450,160+o,480);//koltuk
	  line(160+o,480,180+o,480);//koltuk
	  circle(270+o,440,10);//metro içindeki yolcu 2 kafa
      line(270+o,450,270+o,480);//metro içindeki yolcu 2 gövde
      line(270+o,480,290+o,500);//metro içindeki yolcu 2 ayak
       line(270+o,460,280+o,470);//metro içindeki yolcu 2 kol
	  line(260+o,450,260+o,480);//koltuk
	  line(260+o,480,280+o,480);//koltuk
      circle(330+o,440,10);//metro içindeki yolcu 3 kafa
      line(330+o,450,330+o,480);//metro içindeki yolcu 3 gövde
      line(330+o,480,350+o,500);//metro içindeki yolcu 3 ayak
       line(330+o,460,340+o,470);//metro içindeki yolcu 3 kol
	  line(320+o,450,320+o,480);//koltuk
	  line(320+o,480,340+o,480);//koltuk 
      circle(430+o,440,10);//metro içindeki yolcu 4 kafa
         line(430+o,450,430+o,480);//metro içindeki yolcu 3 gövde
      line(430+o,480,450+o,500);//metro içindeki yolcu 3 ayak
       line(430+o,460,440+o,470);//metro içindeki yolcu 3 kol
...
//yol
 ...
 // metronun kendisi icin renk degisimi
      ...
      circle(70+o,440,10);//metro içindeki yolcu 1 kafa
      line(70+o,450,70+o,480);//metro içindeki yolcu 1 gövde
      line(70+o,480,90+o,500);//metro içindeki yolcu 1 ayak
       line(70+o,460,80+o,470);//metro içindeki yolcu 1 kol
	  line(60+o,450,60+o,480);//koltuk
	  line(60+o,480,80+o,480);//koltuk
	  circle(170+o,440,10);//metro içindeki yolcu 2 kafa
      line(170+o,450,170+o,480);//metro içindeki yolcu 2 gövde
      line(170+o,480,190+o,500);//metro içindeki yolcu 2 ayak
       line(170+o,460,180+o,470);//metro içindeki yolcu 2 kol
	  line(160+o,450,160+o,480);//koltuk
	  line(160+o,480,180+o,480);//koltuk
	   circle(230+o,440,10);//metro içindeki yolcu 3 kafa
      line(230+o,450,230+o,480);//metro içindeki yolcu 3 gövde
      line(230+o,480,250+o,500);//metro içindeki yolcu 3 ayak
       line(230+o,460,240+o,470);//metro içindeki yolcu 3 kol
	  line(220+o,450,220+o,480);//koltuk
	  line(220+o,480,240+o,480);//koltuk 
      circle(330+o,440,10);//metro içindeki yolcu 4 kafa
         line(330+o,450,330+o,480);//metro içindeki yolcu 3 gövde
      line(330+o,480,350+o,500);//metro içindeki yolcu 3 ayak
       line(330+o,460,340+o,470);//metro içindeki yolcu 3 kol
	  line(320+o,450,320+o,480);//koltuk
	  line(320+o,480,340+o,480);//koltuk 
	  circle(380+o,440,10);//metro içindeki yolcu 5 kafa
         line(380+o,450,380+o,480);//metro içindeki yolcu 5 gövde
      line(380+o,480,400+o,500);//metro içindeki yolcu 5 ayak
       line(380+o,460,390+o,470);//metro içindeki yolcu 5 kol
	  line(370+o,450,370+o,480);//koltuk
	  line(370+o,480,390+o,480);//koltuk 
	  circle(480+o,440,10);//metro içindeki yolcu 6 kafa
         line(480+o,450,480+o,480);//metro içindeki yolcu 6 gövde
      line(480+o,480,500+o,500);//metro içindeki yolcu 6 ayak
       line(480+o,460,490+o,470);//metro içindeki yolcu 6 kol
